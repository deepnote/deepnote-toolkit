...
- `builder.Dockerfile`: Creates Python package bundles for different versions (3.10-3.14), generates kernel and server bundles, and packages the toolkit for distribution using Poetry.
